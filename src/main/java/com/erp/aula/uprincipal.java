...
public class uprincipal extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       uproduto cadastro = new uproduto();
                cadastro.setSize(1017,550);
                cadastro.setDefaultCloseOperation(uproduto.DISPOSE_ON_CLOSE);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                uprincipal form = new uprincipal();
                form.setSize(1024,780);
